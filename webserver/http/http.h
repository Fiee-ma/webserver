...
public:
    ...
    void setQuery(const std::string &str) { m_query = str;}
    void setFragment(const std::string &str) { m_fragment = str;}
    void setBody(const std::string &str) { m_body = str;}
...
//        return getAs(m_cookies, key, val, def);
//    }
