...
public:
    ...
    static Socket::ptr CreateTCP(server_name::Address::ptr address);
    static Socket::ptr CreateUDP(server_name::Address::ptr address);
    ...
    int recvFrom(iovec *buffers, size_t length, Address::ptr, int flags = 0);
